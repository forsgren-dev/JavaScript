...
(async () => {
  ...
  let reqUrl = `${url}/MusicGroups/Read?flat=false&pageNr=0&pageSize=10&filter=Floyd`;
  ...
  reqUrl = `${url}/MusicGroups/ReadItem?flat=false&id=${data.pageItems[0].musicGroupId}`;
  ...
  reqUrl = `${url}/MusicGroups/DeleteItem/${musicgroupId}`;
